    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#"
          >CHALET<span class="text-warning">MED</span></a
        >
        <button
            ...
            <div class="col-md-6">
                @if ($coord->logo)
                    <div class="logo-container">
                        <img src="{{ asset('uploads/photos/'.$coord->logo) }}" alt="Logo de la banque" style="height: 50px; width: 50px;" class="logo">
                    </div>
                @endif
            </div>
            @endif
...
Saisir et d'importer les reçus de paiement des charges fixes mensuelles et occasionnelles.
             </p>
