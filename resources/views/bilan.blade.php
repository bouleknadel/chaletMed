...
@section('titre')
    <h3 class="card-title font-weight-bold" style="font-size: 24px;">BILAN ANNUEL DE L'ANNÉE
        {{ $selectedYear }}/{{ $selectedYear + 1 }}</h3>
@endsection
                            ...
                            <table id="table-actifs" class="table table-bordered table-striped tablebilan">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="bg-success text-white font-weight-bold" style="opacity: 0.8;">
                                            {{ $cotisationsPayeesAnneeEnCours }} DH</td>
                                    </tr>
                                    <tr>
                                        <td>Montant non payé dans l'année en cours ({{ date('Y') }})</td>
                                        <td class="bg-success text-white font-weight-bold" style="opacity: 0.8;">
                                            {{ $cotisationsNonPayeesAnneeEnCours }} DH</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bg-success text-white font-weight-bold" style="opacity: 0.8;">
                                            {{ $cotisationsPartiellesAnneeEnCours }} DH</td>
                                    </tr>
                                    <tr>
                                        <td>Montant en cours de validation dans l'année en cours ({{ date('Y') }})</td>
                                        <td class="bg-success text-white font-weight-bold" style="opacity: 0.8;">
                                            {{ $cotisationsEnCoursValidationAnneeEnCours }} DH</td>
                                    </tr>
                                    <tr>
                                        @php
                                        ...
                                        @endphp
                                        <td>Total</td>
                                        <td class="bg-success text-white font-weight-bold larger-size"
                                            style="opacity: 0.8; font-size: 18px;">{{ $totalActif }} DH</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($chargesRubriquesMontants as $chargeRubriqueMontant)
                                        <tr>
                                            ...
                                            <td class="bg-danger text-white font-weight-bold" style="opacity: 0.8;">
                                                {{ $chargeRubriqueMontant->total }} DH</td>
                                        </tr>
                                        @php
                                    ...
                                    <tr>
                                        <td>Total</td>
                                        <td class="bg-danger text-white font-weight-bold larger-size"
                                            style="opacity: 0.8; font-size: 18px;">{{ $totalCharge }} DH</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="table-passifs" class="table table-bordered table-striped tablebilan">
                            <thead>
                                <tr>
                                    <th colspan="2" style="font-size: 18px ; font-weight : 700 ;">RÉSULTAT NET
                                        D'EXPLOITATION</th>
                                    <th colspan="2"
                                        style="background-color: {{ $totalActif - $totalCharge >= 0 ? 'green' : 'red' }}; font-size: 20px;"
