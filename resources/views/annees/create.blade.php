      ...
      <div class="col-md-9 m-auto">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Ajouter prix location Annees</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form method="POST" action="{{ route('annees.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="prix_location" name="prix_location" placeholder="Entrez le prix_location">
        </div>
    </div>
